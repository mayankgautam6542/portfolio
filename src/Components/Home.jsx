    ...
    <div name="home" className="h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 pb-10">
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          <h2 className="text-4xl sm:text-7xl font-bold text-white mt-12">I'm a <span className='text-cyan-500'>Full Stack</span> Developer</h2>
          ...
          I really enjoy building Web-Applications that are easy for people to use and and have responsive UI design for enhanced accessibility
           and user engagement using technologies like ReactJS, ExpressJS, NodeJs integrating it with MongoDB</p>
            <div>
        ...
        <div>
        {/* <img className="w-auto h-auto md:w-[400px] md:h-[400px] rounded-2xl mb-10" src={heroImage} alt="my Profile" /> */}
          <img className="w-110 h-80 rounded-3xl mr-20 mb-10 mt-14 ml-10 " src={heroImage} alt="my Profile" />
        </div>
      </div>
    </div>
  )
