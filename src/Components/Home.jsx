    ...
    <div name="home" className="h-screen w-full bg-gradient-to-b from-black via-black to-gray-800">
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          <h2 className="text-4xl sm:text-7xl font-bold text-white">I'm a <span className='text-cyan-500'>Front End</span> Developer</h2>
          <p className="py-4 text-gray-500 max-w-md">
          I really enjoy building Web-Applications that are easy for people to use and have cool interactive features using technologies like JavaScript, React, Tailwind and NodeJs </p>
            <div>
